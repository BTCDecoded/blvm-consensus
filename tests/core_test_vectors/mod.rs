...
pub use script_tests::{
    WitnessScriptTestVector, load_default_script_vectors, load_default_witness_script_vectors,
    load_script_test_vectors, parse_flag_string, run_core_script_tests, score_core_script_tests,
    score_witness_script_tests,
};
